...
public class Op_EQ implements IOperatorExecution {
    ...
    public Constant execute(Constant[] args) throws IllegalExpressionException {
        ...
        //集合类型EQ运算单独处理
        if (BaseDataMeta.DataType.LIST == first.getDataType() || BaseDataMeta.DataType.LIST == second.getDataType()) {
        ...
        if (BaseDataMeta.DataType.NULL == first.getDataType()) {
            ...
            if (BaseDataMeta.DataType.BOOLEAN == first.getDataType() && BaseDataMeta.DataType.BOOLEAN == second.getDataType()) {
            ...
            } else if (BaseDataMeta.DataType.DATE == first.getDataType() && BaseDataMeta.DataType.DATE == second.getDataType()) {
                //日期比较精确到秒
